...
class Polynomial : public Function
{
    ...
    private:
        Function*base,*exp;
        Polynomial(Function*base,Function*exp):base(base),
        exp(exp){};
};
...
class Arithmetic : public Function
{
	...
	Function *differential() override
    {
        switch(type)
        {
            ...
            case Type::MUL:
                return new Arithmetic(new Arithmetic(lhs->differential(),Type::MUL,rhs),Type::ADD,new Arithmetic(lhs,Type::MUL,rhs->differential()));
            case Type::DIV:
                return new Arithmetic(new Arithmetic(new Arithmetic(lhs->differential(),Type::MUL,rhs),Type::SUB,new Arithmetic(lhs,Type::MUL,rhs->differential())),Type::DIV,
    ...
    Function *lhs,*rhs;
    Type type;
    Arithmetic(Function*lhs,Type type,Function*rhs):
...
{
    return Arithmetic::create(Polynomial::create(base,Arithmetic::create(exp,'-',Constant::create(1))),'*',base->differential());
}
